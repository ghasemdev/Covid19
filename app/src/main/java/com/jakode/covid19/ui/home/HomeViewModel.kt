...
class HomeViewModel @ViewModelInject constructor(
    ...
    private val _dataState: MutableLiveData<DataState<GlobalAndStatistics>> by lazy { MutableLiveData() }
    val dataState: LiveData<DataState<GlobalAndStatistics>> get() = _dataState
